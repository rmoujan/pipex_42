...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   backup_pipex_afterleaks_andOtrunc.c                :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: rmoujan < rmoujan@student.1337.ma>         +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/04/11 10:47:07 by rmoujan           #+#    #+#             */
/*   Updated: 2022/04/11 10:47:10 by rmoujan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*   Updated: 2022/04/11 10:37:43 by rmoujan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char *argv[], char *const envp[])
{
   ...
   // int status;
    ...
    id.fd2 = open(argv[4], O_RDWR | O_TRUNC);
